...
public class Camera {
    ...
    final static double VIEW_ANGLE = 37.4;  // Axis M1011 camera
    ...
    public boolean findTarget() {
        ...
        while (CommandBase.ds.isAutonomous() && CommandBase.ds.isEnabled()) {
            try {
                /**
                ...
                if (filteredImage.getNumberParticles() > 0) {
                    ...
                    if (verticalTargetCount > 0) {
                        ...
                        if (target.Hot) {
                            System.out.println("Found Hot Target!");
                            /**
                             * all images in Java must be freed after they are
                             * used since they are allocated out of C data
                             * structures. Not calling free() will cause the
